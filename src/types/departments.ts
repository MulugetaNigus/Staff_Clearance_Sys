...
export const CLEARANCE_DEPARTMENTS: Department[] = [
  ...
  // Stage 2: General Departmental Clearance (Parallel)
  {
    id: '2',
    name: 'Registrar',
  ...
  // Stage 3: Asset & Property Clearance
  {
    id: '11',
  ...
  // Stage 5: Final Approvals & Archiving
  {
    id: '26',
  ...
  // VP's second approval is handled by the workflow, not duplicated here.
  {
    id: '23',
